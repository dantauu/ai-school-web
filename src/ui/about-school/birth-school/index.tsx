...
export const BirthSchoolSection = () => {
  return (
    <div className="flex flex-col gap-10">
      ...
      <div>
        <CardBlur
          className="w-full flex 830:gap-5 gap-2 justify-between overflow-x-auto"
          classItem="h-[140px] 830:h-[220px] w-[308px] 830:max-w-[500px] 830:w-full 1155:shrink shrink-0"
          classText="830:text-[24px] text-[19px] max-w-[430px]"
