...
import { resultListSpecial, skillsListSpecial } from "@/lib/data/more-course/for-special"
...
export const SpecialPage = () => {
  return (
    <div>
        <Breadcrumbs className="py-[30px] px-[40px]" location={"Курс «AI для специалистов и предпринимателей»"} />
      <div className="flex flex-col gap-25 container">
        ...
        <AfterSpecialSection />
        <AiStandardSection />
        <CouchSpecialSection description={"Практики, которые сами используют нейросети каждый день — в бизнесе, маркетинге, дизайне и технологиях."} />
        <ReviewsSection />
