...
export const FaqPage = () => {
  return (
    <div className="pt-[20px] container">
      ...
      <h3 className="975:text-[60px] 975:pb-0 pb-5 975:leading-normal leading-10 text-[32px]">Политика конфиденциальности</h3>
      <div className="flex flex-col gap-5">
        ...
        <div>
          <p className="975:text-[32px] text-[20px] pb-2">Основные понятия, используемые в Политике</p>
